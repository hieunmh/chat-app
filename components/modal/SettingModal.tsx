    ...
    <Modal isOpen={isOpen} onClose={onClose}>
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className='space-y-12'>
          <div className='border-b border-b-[#797979] pb-12'>
            ...
            <div className='mt-10 flex flex-col gap-y-8'>
              <Input disabled={isLoading} label='Name' id='name' dark errors={errors} required register={register} />
          ...
          <div className='mt-6 flex items-center justify-end gap-x-6 text-[#d2d2d2]'>
            <button className='px-3 py-2 text-sm font-normal tracking-[0.5px]'
              onClick={onClose}
            >
              Cancel
            </button>
